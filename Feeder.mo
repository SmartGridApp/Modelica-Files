connector Feeder "Generalized electric terminal"
  extends Buildings.Electrical.Interfaces.BaseTerminal;
  replaceable package PhaseSystem = Buildings.Electrical.PhaseSystems.OnePhase "Phase system" annotation(
...
Proc. of the 10th Modelica Conference, Lund, Sweden, March 2014.
    ...
    Diagram(coordinateSystem(initialScale = 0.1), graphics = {Rectangle(origin = {0, 10}, lineColor = {0, 0, 255}, fillColor = {0, 0, 255}, fillPattern = FillPattern.Solid, extent = {{-240, 10}, {240, -10}})}),
  Icon(coordinateSystem(initialScale = 0.1), graphics = {Rectangle(origin = {0, 10}, lineColor = {0, 0, 255}, fillColor = {0, 0, 255}, fillPattern = FillPattern.Solid, extent = {{-240, 10}, {240, -10}}), Text(origin = {-3, 37}, extent = {{-55, 9}, {55, -9}}, textString = "%name")}));
end Feeder;